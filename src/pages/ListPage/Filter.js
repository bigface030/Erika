...
const ColorSpan = styled.span`
    ...
    border: ${props =>
        (props.$border || props.$color === 'black') && 'thin solid #333'};
    border: ${props =>
        props.$border && props.$color === 'black' && 'medium double #eee'};
    width: 30px;
    height: 30px;
...
export const Filter = () => {
    ...
    const clearedSearch = newSearch.has('order')
        ? new URLSearchParams({ order: newSearch.get('order') })
        : null;
